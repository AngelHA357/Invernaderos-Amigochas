...
public class DataLoader {
    ...
    CommandLineRunner initData(IInvernaderosRepository invernaderosRepository, IGestionSensoresRepository gestionSensoresRepository) {
        return args -> {
            if (invernaderosRepository.count() == 0 && gestionSensoresRepository.count() == 0) {
                ...
                // Insertar sensores
                gestionSensoresRepository.save(new Sensor(null, "SEN-0101", "AA:BB:CC:DD:EE:FF", "SensorTech", "ST-100", "Humedad", "%", new ObjectId(invA.get_id()), "Sector 1", "Fila A"));
                gestionSensoresRepository.save(new Sensor(null, "SEN-0202", "11:22:33:44:55:66", "EcoSense", "ES-200", "Temperatura", "C", new ObjectId(invB.get_id()), "Sector 2", "Fila B"));
                gestionSensoresRepository.save(new Sensor(null, "SEN-0303", "AA:11:BB:22:CC:33", "TempTech", "T-300", "Temperatura", "F", new ObjectId(invC.get_id()), "Sector 1", "Fila A"));
                gestionSensoresRepository.save(new Sensor(null, "SEN-0404", "66:55:44:33:22:11", "GreenGrow", "GG-500", "Temperatura", "K", new ObjectId(invD.get_id()), "Sector 1", "Fila A"));
                gestionSensoresRepository.save(new Sensor(null, "SEN-0505", "77:88:99:AA:BB:CC", "AgroSense", "AS-400", "Humedad", "%", new ObjectId(invE.get_id()), "Sector 2", "Fila B"));
