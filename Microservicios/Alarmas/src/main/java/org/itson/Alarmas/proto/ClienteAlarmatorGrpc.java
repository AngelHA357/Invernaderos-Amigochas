...
@Component
public class ClienteAlarmatorGrpc {
    private AlarmatorServidorGrpc.AlarmatorServidorBlockingStub stub;

    public ClienteAlarmatorGrpc(@GrpcClient("Alarmator") AlarmatorServidorGrpc.AlarmatorServidorBlockingStub stub) {
        this.stub = stub;
    }

    public void registrarAlarma(AlarmaDTO alarmaDTO) {
        Alarmator.AlarmaDTO alarmaNueva = Alarmator.AlarmaDTO.newBuilder()
    ...
    public void eliminarAlarma(String idAlarma) {
        Alarmator.AlarmaDTO alarmaDTO = Alarmator.AlarmaDTO
                .newBuilder()
    ...
    public void actualizarAlarmas(List<AlarmaDTO> alarmas) {
        List<Alarmator.AlarmaDTO> alarmasGrpc = new ArrayList<>();
        for (AlarmaDTO alarma : alarmas) {
            alarmasGrpc.add(
                    Alarmator.AlarmaDTO.newBuilder()
        ...
        Alarmator.AlarmasList alarmasList = Alarmator.AlarmasList.newBuilder()
